const topConv= new State('Hello, we are NTU Libraries! <br>We are here to help answer some of your questions! <br>What would you like to find out about?',['Opening Hours','Booking Spaces', 'Library Locations', 'Requesting Materials', 'Exam Materials'],[]);
const openingHours= new State('Choose your time period:',['Vacation', 'Semester Period', 'LWN Extended Hours'],[]);
