const topConv= new State('Hello, we are NTU Libraries! <br>We are here to help answer some of your questions! <br>What would you like to find out about?',['Opening Hours','Booking Spaces', 'Library Locations', 'Requesting Materials', 'Exam Materials'],[],['openingHours', 'bookSpaces', 'libLocations','reqMat','examPapers']);
const openingHours= new State('Choose your time period:',['Vacation', 'Semester Period', 'LWN Extended Hours'],[],['vacation', 'semPeriod', 'extendedPeriod']);
...
const admLoc= new State('Here you go! &#9786;<br><br>Art, Design & Media Library<br><b>ART &mdash; 01 &mdash; 03</b><br><a target=\'_blank\' href=\'http://maps.ntu.edu.sg/maps#q:Art%2c%20Design%20&%20Media%20Library%20%28ADM%29\'>Locate us</a> <br> Hope you enjoy your experience at NTU Library!',['Ok'],[],['']);
const bizlibLoc= new State('Here you go! &#9786;<br><br>Business Library<br><b>N2 &mdash; B2b &mdash; 07</b><br><a target=\'_blank\' href=\'http://maps.ntu.edu.sg/maps#q:BUSINESS%20LIBRARY\'>Locate us</a><br>Hope you enjoy your experience at NTU Library!',['Ok'],[],['']);
...
const bookSpaces= new State('This section is under construction.<br>Sorry &#9785;',['Ok'],[],['']);
